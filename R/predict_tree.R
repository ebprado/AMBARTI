...
predict_ambarti = function(object, newdata,
  ...
  out = switch(type,
               ...
               mean = object$y_mean + apply(object$beta_hat,2,'mean') + object$y_sd * apply(y_hat_mat,2,'mean'),
               median = object$y_mean + apply(object$beta_hat,2,'median') + object$y_sd * apply(y_hat_mat,2,'median'))
