...
date: "February 23rd, 2021 - Group meeting"
...
## INNOVAR project: wheat data \includegraphics[width=0.05\linewidth]{wheat2.png}

\begin{itemize}
\item European Union Horizon 2020 project INNOVAR: improve the efficacy and accuracy of European crop variety testing and on-farm decision-making. 
\vspace{0.2cm}
\item INNOVAR is a collaboration between 22 different partners across Europe.
\vspace{0.2cm}
\item Each year has $\sim 20$ genotypes and $\sim 8$ environments (4 replicates). 
\vspace{0.2cm}
\item The response variable is the production of wheat in tonnes per hectare.
...
\begin{enumerate} 
  \vspace{0.005cm}
	\item Starting writing the paper.
\end{enumerate}

## Guess what!

\begin{center}
\includegraphics[width=0.95\linewidth]{DieysU5W4AATr0W.jpg}
\end{center}

## Guess what!

\begin{center}
\includegraphics[width=0.70\linewidth]{funny-birthday-good-for-your-health-memes.jpg}
\end{center}
